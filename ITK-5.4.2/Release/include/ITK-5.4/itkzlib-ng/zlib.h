...
#define itkzlib_deflateInit(strm, level) deflateInit_((strm), (level), ZLIB_VERSION, (int)sizeof(z_stream))
#define itkzlib_inflateInit(strm) inflateInit_((strm), ZLIB_VERSION, (int)sizeof(z_stream))
#define itkzlib_deflateInit2(strm, level, method, windowBits, memLevel, strategy) \
        deflateInit2_((strm), (level), (method), (windowBits), (memLevel), \
                     (strategy), ZLIB_VERSION, (int)sizeof(z_stream))
#define itkzlib_inflateInit2(strm, windowBits) inflateInit2_((strm), (windowBits), ZLIB_VERSION, (int)sizeof(z_stream))
...
#  define itkzlib_gzgetc(g) ((g)->have ? ((g)->have--, (g)->pos++, *((g)->next)++) : (itkzlib_gzgetc)(g))
...
#    define itkzlib_crc32_combine_gen itkzlib_crc32_combine_gen64
#  ifndef Z_LARGE64
     Z_EXTERN gzFile Z_EXPORT itkzlib_gzopen64(const char *, const char *);
     Z_EXTERN z_off_t Z_EXPORT itkzlib_gzseek64(gzFile, z_off_t, int);
     Z_EXTERN z_off_t Z_EXPORT itkzlib_gztell64(gzFile);
     Z_EXTERN z_off_t Z_EXPORT itkzlib_gzoffset64(gzFile);
     Z_EXTERN unsigned long Z_EXPORT itkzlib_adler32_combine64(unsigned long, unsigned long, z_off_t);
     Z_EXTERN unsigned long Z_EXPORT itkzlib_crc32_combine64(unsigned long, unsigned long, z_off_t);
     Z_EXTERN unsigned long Z_EXPORT itkzlib_crc32_combine_gen64(z_off64_t);
#  endif
#else
#  ifndef Z_SOLO
   Z_EXTERN gzFile Z_EXPORT itkzlib_gzopen(const char *, const char *);
   Z_EXTERN z_off_t Z_EXPORT itkzlib_gzseek(gzFile, z_off_t, int);
   Z_EXTERN z_off_t Z_EXPORT itkzlib_gztell(gzFile);
   Z_EXTERN z_off_t Z_EXPORT itkzlib_gzoffset(gzFile);
#  endif
   Z_EXTERN unsigned long Z_EXPORT itkzlib_adler32_combine(unsigned long, unsigned long, z_off_t);
   Z_EXTERN unsigned long Z_EXPORT itkzlib_crc32_combine(unsigned long, unsigned long, z_off_t);
   Z_EXTERN unsigned long Z_EXPORT itkzlib_crc32_combine_gen(z_off_t);
#endif
