...
nm lib/libitkpng-5.4.a 2> /dev/null | grep " T \| D \| R " |
 awk '{ print substr($3, 1); }' | sort | awk '!/itk_png_/ { print }' |
 sed 's \(.*\) \1\ itk_png_\1 ' | sed 's/^/#define /'
...
#define _png_read_filter_row_avg3_neon itk_png___png_read_filter_row_avg3_neon
#define _png_read_filter_row_avg4_neon itk_png___png_read_filter_row_avg4_neon
#define _png_read_filter_row_paeth3_neon itk_png___png_read_filter_row_paeth3_neon
#define _png_read_filter_row_paeth4_neon itk_png___png_read_filter_row_paeth4_neon
#define _png_read_filter_row_sub3_neon itk_png___png_read_filter_row_sub3_neon
#define _png_read_filter_row_sub4_neon itk_png___png_read_filter_row_sub4_neon
#define _png_read_filter_row_up_neon itk_png___png_read_filter_row_up_neon
